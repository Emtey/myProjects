...
namespace MoonShooter
{
    public class Game : IDisposable
    {
        ...
        //static string m_PicturesPath = "";
        //static string m_MusicPath = "";
        //static string m_SoundPath = "";
        ...
        {
            get { return m_PicturesPath; }
            set { m_PicturesPath = value; }
        }
        ...
        {
            get { return m_SoundPath; }
            set { m_SoundPath = value; }
        }

        public static Size Resolution
        {
            get { return m_GameWindow.ClientSize; }
        ...
        {
            get { return (int)Math.Ceiling(Stopwatch.Frequency / m_CurrentFrameTime); }
        }
